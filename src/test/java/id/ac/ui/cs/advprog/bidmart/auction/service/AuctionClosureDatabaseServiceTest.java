...
class AuctionClosureDatabaseServiceTest {
    ...
    @Test
    void closeAuction_wonScenario_setsStatusAndPublishesWinnerDeterminedEvent() {
    ...
    @Test
    void closeAuction_unsoldScenario_setsStatusAndPublishesAuctionClosedEvent() {
    ...
    @Test
    void closeAuction_noBids_closesAsUnsold() {
        when(auctionRepository.findById("auc-1")).thenReturn(Optional.of(auction));
    ...
    @Test
    void closeAuction_noReservePrice_wonWithAnyBid() {
    ...
    @Test
    void closeAuction_alreadyWon_skipsProcessing() {
        Auction alreadyWon = new Auction();
        alreadyWon.setId("auc-1");
        alreadyWon.setStatus(AuctionStatus.WON);
